...
/**
 * MediaTargetCreatePayload Class Doc Comment
 *
 * @category Class
 * @package  Cloudinary
 * @author   OpenAPI Generator team
 ...
 */
class MediaTargetCreatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MediaTargetCreatePayload';
     ...
     * Sets display_name
     *
     * @param string $display_name The display name of the media target.
     *
     * @return self
     */
     ...
     * Sets source_type
     *
     * @param string $source_type The type of media target.
     *
     * @return self
     */

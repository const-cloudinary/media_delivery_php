...
/**
 * MediaSourceUpdatePayload Class Doc Comment
 *
 * @category Class
 * @package  Cloudinary
 * @author   OpenAPI Generator team
 ...
 */
class MediaSourceUpdatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MediaSourceUpdatePayload';
    ...
    protected static $openAPITypes = [
        'display_name' => 'string',
        'source_type' => 'string',
        'config' => '\Cloudinary\Model\MediaSourceConfig'
    ];
     ...
     * Sets display_name
     *
     * @param string|null $display_name The display name of the media source.
     *
     * @return self
     */
     ...
     * Sets source_type
     *
     * @param string|null $source_type The type of media source.
     *
     * @return self
     */
     ...
     * Gets config
     *
     * @return \Cloudinary\Model\MediaSourceConfig|null
     */
     ...
     * Sets config
     *
     * @param \Cloudinary\Model\MediaSourceConfig|null $config config
     *
     * @return self
     */

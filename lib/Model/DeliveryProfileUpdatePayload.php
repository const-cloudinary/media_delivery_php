...
/**
 * DeliveryProfileUpdatePayload Class Doc Comment
 *
 * @category Class
 * @package  Cloudinary
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryProfileUpdatePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryProfileUpdatePayload';
     ...
     * Sets display_name
     *
     * @param string|null $display_name The display name of the delivery profile.
     *
     * @return self
     */
     ...
     * Sets domain_id
     *
     * @param string|null $domain_id The ID of the domain name.
     *
     * @return self
     */
     ...
     *
     * @param string|null $mapping_function_id The ID of the mapping function.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $media_source_ids An array of media source IDs.
     *
     * @return self
     */
     ...
     * Sets is_enabled
     *
     * @param bool|null $is_enabled Whether the delivery profile is enabled
     *
     * @return self
     */
